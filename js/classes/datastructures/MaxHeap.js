/**
 * Repräsentiert einen einfachen Max-Heap. Laufzeiten für's Einfügen: O(log(n)),
 * Größtes Element entfernen: O(log(n)). Datenstruktur: Binärbaum als 1D-Array.
 * 
 * @author Phil
 */
